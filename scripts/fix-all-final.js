 ...
 * Processes files systematically and fixes all hardcoded strings
 */
...
function fixHardcodedStrings(content) {
  let changes = 0;
...
function fixFile(filePath) {
  ...
  const { content: content2, changes: changes2 } = fixHardcodedStrings(content);
  content = content2;
