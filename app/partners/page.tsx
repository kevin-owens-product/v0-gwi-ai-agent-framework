...
export default function PartnersPage() {
  const partners = [
    { name: "Google Cloud", logo: "/google-logo.png", category: "Infrastructure" },
    { name: "Tableau", logo: "/tableau-logo.png", category: "Analytics" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <h1 className="text-4xl font-bold text-foreground mb-4">Partners</h1>
            <p className="text-lg text-muted-foreground">
              We partner with leading technology companies to deliver the best experience.
            </p>
          </div>
          ...
          <div className="mb-12 p-8 rounded-lg border border-border bg-card">
            ...
            <p className="text-muted-foreground mb-6">
              Join our partner ecosystem and help enterprises unlock human insights at scale.
            </p>
            <Button>Apply to Partner Program</Button>
          </div>

          <h2 className="text-2xl font-semibold text-foreground mb-8">Our Partners</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {partners.map((partner, idx) => (
              ...
              >
                ...
                <h3 className="font-medium text-foreground text-center">{partner.name}</h3>
