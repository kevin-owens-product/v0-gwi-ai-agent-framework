      ...
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <Button asChild className="mt-4">
            <Link href="/gwi/services/clients">Back to Clients</Link>
          </Button>
        </div>
      </div>
    )
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {editing ? "Edit client information" : "Basic client information"}
              </CardDescription>
            </CardHeader>
              ...
              {editing ? (
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Net {client.paymentTerms}</p>
                  </div>
                  <div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Billing history for {client.name}
                </CardDescription>
              </div>
              <Button size="sm" asChild>
