...
import { storeAgents, iconMap, installAgent, isAgentInstalled } from "@/lib/store-agents"
...
export default function StoreAgentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    setIsInstalled(isAgentInstalled(id))
  }, [id])
  ...
  const IconComponent = iconMap[agentDetails.iconName]
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-3">
            {isInstalled ? (
              ...
              <>
                <Button onClick={handleInstall} variant="outline" className="gap-2" disabled={isInstalling}>
                  {isInstalling ? (
